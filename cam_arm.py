...
cavity_d_trans, exten_d_trans = d_trans - tol, d_trans + tol
...
scad_render_to_file(camera_pole_bottom, f"camera_pole_bot.scad")
scad_render_to_file(camera_pole_toppom, f"camera_pole_top.scad")

os.system(f"openscad -o camera_pole_bot.stl camera_pole_bot.scad")
os.system(f"openscad -o camera_pole_top.stl camera_pole_top.scad")
